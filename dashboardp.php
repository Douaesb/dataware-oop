...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submitadd'])) {
    ...
    $productOwner->addProject($name, $descrp);
...
if (isset($_GET['id_pro'])) {
    $idpro = $_GET['id_pro'];
    $productOwner->deleteProject($idpro);
    header('Location: dashboardp.php');
    exit();
}
...
if (isset($_POST['submits'])) {
    ...
    $id = $_POST['id']; 
    $role = 'ScrumMaster';
    $productOwner->AssignScrum($role,$idpro,$id);
    header('Location: dashboardp.php');
    exit();
}
                        ...
                        <div id="Project" class="hidden">
                            <div class="">
                                ...
                                <form action="" method="post">
                                    ...
                                    <button type="submit" name="submitadd" class=" mt-4 ml-14 text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Ajouter</button>

                                </form>
                            </div>

                            <div class="">
                                <button type="submit" name="submit" class="block py-2 px-3 text-pink-500 font-bold rounded hover:bg-blue-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"><a href="index.php?action=dashboardp" class="">Retour</a>
                                </button>
                            </div>
                        </div>
                        </a>
                                    ...
                                    <tbody class="divide-y divide-gray-200 bg-white">
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                                    ...
                                                    <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-center text-sm font-medium sm:pr-6 lg:pr-8">
                                                        <a href="dashboardp.php?id_pro=<?php echo $row['id_pro']; ?>" class="text-indigo-600 hover:text-indigo-900">Supprimer<span class="sr-only"></span></a>
                                                    </td>
                                        </tr>
                                <?php }
                                            } else {
                                    ...
                                    <tbody class="divide-y divide-gray-200 bg-white">
                                        ...
                                        <?php
                                            ...
                                            ?>
                                                    ...
                                                    <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-center text-sm font-medium sm:pr-6 lg:pr-8">
                                                        <a href="dashboardp.php?id=<?php echo $row['id']; ?>" class="text-indigo-600 hover:text-indigo-900">Supprimer<span class="sr-only"></span></a>
                                                    </td>
                                        </tr>
                                <?php
                                                }

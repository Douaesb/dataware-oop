...
$squads = $scrum->displaySquads();
$squadpro = $scrum->displaySquadPro();

if (isset($_POST['filtrer'])) {
    $selectedTeamId = $_POST['equipe'];
    $Eqpmembers = $scrum->FiltrerEqpMem($selectedTeamId);
}else{
    $Eqpmembers = $scrum->displayEqpMem();
}

if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    $nom_equipe = $_POST['nom_equipe'];
    $date_creation = $_POST['date_creation'];
    $scrum->addSquad($nom_equipe, $date_creation);
...
if (isset($_POST['sbmt'])) {
    ...
    $id_pro = $_POST['id_pro']; 
    $scrum->AssignEqpToPro($id_pro,$id_equipe);
    header('Location: dashboards.php');
    exit();
}
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0">
                    ...
                    <li>
                        <a href="dashboards.php?deconn" class="block py-2 px-3 text-pink-500 rounded hover:bg-blue-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Deconnexion</a>
                    </li>
                </ul>
            </div>
        </div>
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                                    ...
                                                    <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-center text-sm font-medium sm:pr-6 lg:pr-8">
                                                        <a href="editSquad.php?id_equipe=<?php echo $row['id_equipe']; ?>" class="text-indigo-600 hover:text-indigo-900">Modifier<span class="sr-only"></span></a>
                                                    </td>
                                                    <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-center text-sm font-medium sm:pr-6 lg:pr-8">
                                                        <a href="dashboards.php?id_equipe=<?php echo $row['id_equipe']; ?>" class="text-indigo-600 hover:text-indigo-900">Supprimer<span class="sr-only"></span></a>
                                                    </td>
                                        </tr>
                                <?php
                                                }
                                    ...
                                    <tbody class="divide-y divide-gray-200 bg-white">
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                                    ...
                                                    <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-center text-sm font-medium sm:pr-6 lg:pr-8">
                                                        <a href="dashboards.php?ideqp=<?php echo $row['id_equipe']; ?>" class="text-indigo-600 hover:text-indigo-900">Supprimer<span class="sr-only"></span></a>
                                                    </td>
                                        </tr>
                                <?php
                                                }
                                    ...
                                    <tbody class="divide-y divide-gray-200 bg-white">
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-center text-sm font-medium sm:pr-6 lg:pr-8">
                                                        <a href="dashboards.php?id=<?php echo $row['id']; ?>" class="text-indigo-600 hover:text-indigo-900">Supprimer<span class="sr-only"></span></a>
                                                    </td>
                                                </tr>
                                        <?php
                                            }
